...
const bucketStyles: Record<string, string> = {
  ...
  new_no_response: "bg-[hsl(var(--warning))]/10 text-[hsl(var(--warning))] border-[hsl(var(--warning))]/20",
    ...
    >
      ...
      {!isLoading && contacts.length > 0 && (
        <div className="flex gap-2 mb-3 flex-wrap">
          ...
          {newNoResponse > 0 && (
            <Badge variant="outline" className="text-[10px] border-[hsl(var(--warning))]/30 text-[hsl(var(--warning))] bg-[hsl(var(--warning))]/5">
        ...
        <div className="space-y-1.5">
          {contacts.slice(0, 5).map((contact: FollowUpContact) => (
            ...
            >
              <Badge
                variant="outline"
                className={`text-[9px] px-1.5 py-0.5 shrink-0 ${bucketStyles[contact.bucket]}`}
              >
