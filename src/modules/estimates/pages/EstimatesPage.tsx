...
export default function EstimatesPage() {
  ...
  return (
    <div className="space-y-5">
      ...
      >
        <div>
          <h1 className="text-3xl font-bold tracking-tight"><span className="font-black text-primary text-4xl">guzzl</span> <span className="font-normal">Estimates</span></h1>
