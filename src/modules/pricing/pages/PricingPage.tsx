...
const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      "List every service you offer, take unlimited bookings",
      "Auto-texts new leads so you never miss a job",
      "Send offers and reminders to past customers",
      "Track every customer from first call to paid invoice",
      "Post to Facebook & Instagram without thinking about it",
      "Run deals and specials right on your page",
      "Your brand only — no guzzl.pro logo on your page",
    ],
  },
  {
    key: "pro_plus",
    ...
    features: [
      ...
      "Get paid before you even show up",
      "An assistant that answers customer questions for you, 24/7",
      "See which months bring the most work — plan ahead",
      "Add your crew so everyone's on the same page",
      "Use your own web address (like mikesplumbing.com)",
      "Looks 100% like your business, nothing else",
      "Jump the queue — get help within the hour",
    ],
  },
];
