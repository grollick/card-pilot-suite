...
const helpSections: HelpSection[] = [
  ...
  },
  {
    ...
    icon: Users,
    description: "Turn card viewers into leads with forms, quotes, scanning, and bookings.",
    articles: [
      ...
      { title: "Scan to Save", description: "Let visitors scan their business card to share their contact info with you." },
      { title: "Business card scanner", description: "Use your camera to scan physical business cards and add contacts." },
    ],
    ...
    faqs: [
      ...
      { q: "What is Scan to Save?", a: "Enable the toggle in your card settings and visitors can photograph their own business card to share their info with you — no typing needed." },
      { q: "How does the business card scanner work?", a: "Go to Contacts → Scan Card. Take a photo or upload an image of a business card and AI extracts the name, email, phone, and company automatically." },
    ],
  },
  {
    ...
    icon: Users,
    description: "Organize contacts, categorize them, track conversations, and close more deals.",
    articles: [
      ...
      { title: "Contact categories", description: "Categorize contacts as leads, clients, vendors, partners, or personal." },
    ],
    video: { title: "Manage Your Leads Like a Pro", description: "CRM best practices for service businesses.", duration: "3 min" },
    faqs: [
      { q: "Can I import contacts?", a: "Yes — you can scan physical business cards with your camera, or contacts are created from card submissions and bookings." },
      { q: "How do I follow up?", a: "Use the task system to set follow-up reminders per contact." },
      { q: "What contact categories are available?", a: "You can categorize contacts as Lead, Client, Vendor, Partner, Personal, or Other. This helps you separate customers from suppliers and networking connections." },
    ],
  },
  {
    id: "booking-clients",
  ...
  },
  {
    ...
    articles: [
      ...
      { title: "AI assistant", description: "Get help writing estimates, messages, and marketing content." },
    ],
    ...
    faqs: [
      ...
      { q: "What can the AI assistant help with?", a: "It can draft estimates, write customer messages, create social media content, and analyze your business performance." },
    ],
  },
];
