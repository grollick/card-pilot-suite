      ...
      <div className="min-h-screen bg-background text-foreground">
        ...
        <nav className="border-b border-border/40 bg-background/80 backdrop-blur-sm sticky top-0 z-50">
          <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
            <Link to="/" className="text-lg font-bold text-primary"><span className="font-bold text-primary">guzzl</span>.pro</Link>
        ...
        <footer className="border-t border-border/40 py-8 text-center">
          <p className="text-xs text-muted-foreground">
            ...
            © {new Date().getFullYear()} <Link to="/" className="text-primary hover:underline"><span className="font-bold text-primary">guzzl</span>.pro</Link> — The smart business card platform for local professionals.
          </p>
        </footer>
      </div>
    </>
