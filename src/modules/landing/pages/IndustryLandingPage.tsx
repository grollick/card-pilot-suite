      ...
      <div className="min-h-screen bg-background text-foreground">
        ...
        <nav className="border-b border-border/40 bg-background/80 backdrop-blur-sm sticky top-0 z-50">
          <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
            <Link to="/" className="text-lg font-bold text-primary"><span className="font-black text-primary text-4xl">guzzl</span>.pro</Link>
                ...
                <div className="max-w-sm mx-auto bg-card rounded-2xl border border-border/60 shadow-lg overflow-hidden mb-6">
                  <div className="p-5" style={{ borderTop: `4px solid ${demo.accentColor}` }}>
                    <div className="flex items-center gap-3 mb-2">
                      <div className="h-12 w-12 rounded-full overflow-hidden ring-2 ring-primary/20 shrink-0">
        ...
        <footer className="border-t border-border/40 py-8 text-center">
          <p className="text-xs text-muted-foreground">
            ...
            © {new Date().getFullYear()} <Link to="/" className="text-primary hover:underline"><span className="font-black text-primary text-4xl">guzzl</span>.pro</Link> — The smart business card platform for local professionals.
          </p>
        </footer>
      </div>
    </>
