    ...
    <div className="space-y-5">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
             <h1 className="text-xl font-bold tracking-tight"><span className="font-extrabold text-primary">guzzl</span> <span className="font-normal">{isNew ? "New Invoice" : invoice?.invoice_number}</span></h1>
            {!isNew && invoice && (
