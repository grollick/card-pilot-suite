      ...
      <div className="relative bg-gradient-to-br from-primary/8 via-background to-primary/4 border-b border-border/40 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-14 md:py-20">
          ...
          <div className="flex items-center gap-2 mb-6">
            <Link to="/" className="text-sm text-muted-foreground hover:text-foreground transition-colors"><span className="font-black text-primary text-4xl">guzzl</span>.pro</Link>
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        <div className="mt-16 pt-8 border-t border-border/40 space-y-2 text-center">
          ...
          <p className="text-xs text-muted-foreground">
            Powered by <Link to="/" className="text-primary hover:underline"><span className="font-black text-primary text-4xl">guzzl</span>.pro</Link> — the smart business card platform that helps local businesses get more customers.
          </p>
        </div>
      </div>
