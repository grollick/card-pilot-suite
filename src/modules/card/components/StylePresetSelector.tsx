...
export const STYLE_PRESETS: StylePreset[] = [
  {
    ...
    tokens: {
      ...
      header: { layout: "centered", avatarShape: "circle" },
      section: { cardStyle: "flat", divider: "line" },
  ...
  },
  {
    ...
    tokens: {
      button: { shape: "sharp", style: "filled", size: "lg" },
      header: { layout: "centered", avatarShape: "square" },
      section: { cardStyle: "outlined", divider: "none" },
  ...
  },
  {
    ...
    tokens: {
      button: { shape: "rounded", style: "outlined", size: "md" },
      header: { layout: "centered", avatarShape: "circle" },
      section: { cardStyle: "glass", divider: "line" },
      spacingScale: "airy",
  ...
  },
  {
    ...
    tokens: {
      button: { shape: "rounded", style: "ghost", size: "sm" },
      header: { layout: "centered", avatarShape: "rounded" },
      section: { cardStyle: "flat", divider: "none" },
      spacingScale: "airy",
