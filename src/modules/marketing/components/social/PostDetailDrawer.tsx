import { Edit2, Copy, Trash2, Send, Clock, ListOrdered, X } from "lucide-react";
...
export default function PostDetailDrawer({ post, onClose, onEdit }: Props) {
  ...
  return (
    <div
      className="fixed inset-y-0 right-0 z-40 w-full sm:w-[420px] bg-background border-l border-border shadow-lg overflow-y-auto pointer-events-auto"
      role="dialog"
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            {post.approval_status === "pending_approval" && (
              <Button
                variant="outline"
                size="sm"
                className="text-xs h-8 gap-1 text-emerald-600"
