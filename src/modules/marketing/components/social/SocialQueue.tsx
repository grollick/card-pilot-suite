...
import { Plus, Trash2, Clock, Pause, Play, GripVertical } from "lucide-react";
...
import { useSocialPosts, useQueueSlots, useCreateQueueSlot, useDeleteQueueSlot, type QueueSlot } from "@/hooks/useSocial";
          ...
          <CardContent className="p-4 flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium">
                {nextPost?.scheduled_at ? format(new Date(nextPost.scheduled_at), "MMM d, h:mm a") : "—"}
              </p>
        ...
        <Card className="dash-card">
          <CardContent className="p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Queue Slots</p>
            </div>
          </CardContent>
        </Card>
        <Card className="dash-card">
          <CardContent className="p-4 flex items-center justify-between">
            <div>
              <p className="text-sm font-medium">{queuePaused ? "Paused" : "Active"}</p>
      ...
      <div className="grid md:grid-cols-[1fr,320px] gap-6">
        ...
        <Card className="dash-card">
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium">Queue Schedule</CardTitle>
          </CardHeader>
        ...
        <Card className="dash-card h-fit">
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium">Add Queue Slot</CardTitle>
          </CardHeader>
          <CardContent className="space-y-3">
            <div>
