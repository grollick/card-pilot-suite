              ...
              parameters: {
                ...
                properties: {
                  ...
                  suggested_categories: {
                    type: "array",
                    items: { type: "string" },
                    description: "3-8 marketplace category keys from this list that best match the profession: landscaping, snow-removal, cleaning, handyman, roofing, junk-removal, moving, lawn-care, plumbing, electrical, painting, hvac, pest-control, fencing, flooring, pressure-washing, tree-service, garage-door, appliance-repair, locksmith, carpentry, masonry, towing, auto-detailing, welding, drywall, window-cleaning, gutter-cleaning, pool-service, septic-service, excavation, concrete, siding, insulation, solar, security-systems, home-inspection, interior-design, photography, catering, event-planning, tutoring, pet-care, personal-training, massage-therapy, notary, tax-prep, accounting, web-design, graphic-design, video-production, dj-services, music-lessons, yoga, childcare, elderly-care, dog-walking, pet-grooming, veterinary, courier, furniture-assembly, upholstery, tailoring, dry-cleaning, car-wash, mechanic, tire-service, boat-repair, small-engine, snow-plowing, irrigation, hardscaping, deck-building, kitchen-remodel, bathroom-remodel, basement-finish, chimney, glass-repair, signage, printing, translation, legal-services, real-estate, home-staging, cleaning-commercial, waste-management, it-support, smart-home, drone-services, carpet-cleaning, mold-remediation, waterproofing, stump-grinding, tile-install, water-heater, wildlife-removal, woodworking, computer-repair, phone-repair, hair-stylist, makeup-artist, tattoo, life-coaching, counseling, private-chef, meal-prep, property-mgmt, bookkeeping, resume-writing, virtual-assistant, mobile-mechanic, ev-charger",
                  },
                  setup_tips: {
                    type: "array",
                    items: { type: "string" },
