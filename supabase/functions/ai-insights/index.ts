                ...
                insights: {
                  ...
                  items: {
                    ...
                    properties: {
                      ...
                      action_label: { type: "string", description: "Short CTA button label like 'Add Photos', 'Follow Up', 'Share Card', 'Send Estimate', 'View Leads' (max 3 words)" },
                      action_route: { type: "string", description: "App route to fix the issue. Use one of: /app/card, /app/contacts, /app/estimates, /app/invoices, /app/bookings, /app/social, /app/settings" },
                    },
