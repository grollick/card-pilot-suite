...
serve(async (req) => {
  ...
  try {
            ...
            function: {
              ...
              parameters: {
                ...
                properties: {
                  ...
                  notes: { type: "string", description: "Any other info on the card" },
                },
                required: ["name"],
    ...
    console.error("scan-business-card-public error:", err);
    return new Response(
      JSON.stringify({ error: "Failed to scan card. Please try again." }),
